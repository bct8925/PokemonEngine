...
public class GamePanel extends JPanel {
  ...
  protected void paintComponent(Graphics g) {
    ...
    buffer = new BufferedImage(main.getWindowWidth(), main.getWindowHeight(),
    ...
    if (!loading) {
      ...
      // Player
      g2.drawImage(main.getPlayer().getImage()
          .getScaledInstance(main.getPlayer().getZoomWidth(), main.getPlayer().getZoomHeight(),
              Image.SCALE_SMOOTH), main.getPlayer().getX(), main.getPlayer().getY(), this);
